...
contract SettingTest is Test {
    ...
    string internal defaultNodeURL = "http://localhost:8545";
    string internal bscNodeURL = defaultNodeURL;
    string internal crossNodeURL = defaultNodeURL;

    function setUp() public virtual {
        bscForkID = vm.createFork(bscNodeURL); // bsc test chain
        crossForkID = vm.createFork(crossNodeURL); // cross test chain
