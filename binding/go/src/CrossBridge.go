...
// IBaseBridgeBridgeTokenArguments, IBaseBridgePermitArguments, IBridgeRegistryFinalizeArguments,
// IBridgeRegistryPendingData, and IBridgeRegistryTokenPair are declared once, shared across every
// binding in this package, in shared_types.go (same package `binding` — no import needed) rather
// than redeclared here, to avoid a duplicate-type compile error against the other contracts that
// also reference these same ABI structs.
