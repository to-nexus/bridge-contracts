...
func (_StandardBridge *StandardBridgeCaller) PendingArguments(opts *bind.CallOpts, remoteChainID *big.Int, index *big.Int) (IBridgeRegistryFinalizeArguments, error) {
	var out []interface{}
	err := _StandardBridge.contract.Call(opts, &out, "pendingArguments", remoteChainID, index)
...
//
// Solidity: function pendingArguments(uint256 remoteChainID, uint256 index) view returns((uint256,uint256,address,address,uint256,bytes))
func (_StandardBridge *StandardBridgeSession) PendingArguments(remoteChainID *big.Int, index *big.Int) (IBridgeRegistryFinalizeArguments, error) {
	return _StandardBridge.Contract.PendingArguments(&_StandardBridge.CallOpts, remoteChainID, index)
}

// PendingArguments is a free data retrieval call binding the contract method 0x1a9a379f.
//
// Solidity: function pendingArguments(uint256 remoteChainID, uint256 index) view returns((uint256,uint256,address,address,uint256,bytes))
func (_StandardBridge *StandardBridgeCallerSession) PendingArguments(remoteChainID *big.Int, index *big.Int) (IBridgeRegistryFinalizeArguments, error) {
	return _StandardBridge.Contract.PendingArguments(&_StandardBridge.CallOpts, remoteChainID, index)
}
...
func (_StandardBridge *StandardBridgeCaller) PendingReason(opts *bind.CallOpts, remoteChainID *big.Int, index *big.Int) (string, error) {
	var out []interface{}
	err := _StandardBridge.contract.Call(opts, &out, "pendingReason", remoteChainID, index)
...
//
// Solidity: function pendingReason(uint256 remoteChainID, uint256 index) view returns(string)
func (_StandardBridge *StandardBridgeSession) PendingReason(remoteChainID *big.Int, index *big.Int) (string, error) {
	return _StandardBridge.Contract.PendingReason(&_StandardBridge.CallOpts, remoteChainID, index)
}

// PendingReason is a free data retrieval call binding the contract method 0x3d3e68c2.
//
// Solidity: function pendingReason(uint256 remoteChainID, uint256 index) view returns(string)
func (_StandardBridge *StandardBridgeCallerSession) PendingReason(remoteChainID *big.Int, index *big.Int) (string, error) {
	return _StandardBridge.Contract.PendingReason(&_StandardBridge.CallOpts, remoteChainID, index)
}
...
func (_StandardBridge *StandardBridgeTransactor) BridgeTokenBatch(opts *bind.TransactOpts, args []IStandardBridgeBridgeTokenArguments) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "bridgeTokenBatch", args)
}

// BridgeTokenBatch is a paid mutator transaction binding the contract method 0x9118b5eb.
//
// Solidity: function bridgeTokenBatch((uint256,address,address,uint256,uint256,uint256,bytes)[] args) payable returns()
func (_StandardBridge *StandardBridgeSession) BridgeTokenBatch(args []IStandardBridgeBridgeTokenArguments) (*types.Transaction, error) {
	return _StandardBridge.Contract.BridgeTokenBatch(&_StandardBridge.TransactOpts, args)
}

// BridgeTokenBatch is a paid mutator transaction binding the contract method 0x9118b5eb.
//
// Solidity: function bridgeTokenBatch((uint256,address,address,uint256,uint256,uint256,bytes)[] args) payable returns()
func (_StandardBridge *StandardBridgeTransactorSession) BridgeTokenBatch(args []IStandardBridgeBridgeTokenArguments) (*types.Transaction, error) {
	return _StandardBridge.Contract.BridgeTokenBatch(&_StandardBridge.TransactOpts, args)
}
...
func (_StandardBridge *StandardBridgeTransactor) ClearPending(opts *bind.TransactOpts, remoteChainIDs *big.Int) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "clearPending", remoteChainIDs)
}

// ClearPending is a paid mutator transaction binding the contract method 0x0b43c02c.
//
// Solidity: function clearPending(uint256 remoteChainIDs) returns()
func (_StandardBridge *StandardBridgeSession) ClearPending(remoteChainIDs *big.Int) (*types.Transaction, error) {
	return _StandardBridge.Contract.ClearPending(&_StandardBridge.TransactOpts, remoteChainIDs)
}

// ClearPending is a paid mutator transaction binding the contract method 0x0b43c02c.
//
// Solidity: function clearPending(uint256 remoteChainIDs) returns()
func (_StandardBridge *StandardBridgeTransactorSession) ClearPending(remoteChainIDs *big.Int) (*types.Transaction, error) {
	return _StandardBridge.Contract.ClearPending(&_StandardBridge.TransactOpts, remoteChainIDs)
}
...
func (_StandardBridge *StandardBridgeTransactor) CreateToken(opts *bind.TransactOpts, remoteChainID *big.Int, remoteToken common.Address, localTokenRate *big.Int, remoteTokenRate *big.Int, safetyLimit *big.Int, symbol string, decimals uint8) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "createToken", remoteChainID, remoteToken, localTokenRate, remoteTokenRate, safetyLimit, symbol, decimals)
}

// CreateToken is a paid mutator transaction binding the contract method 0x79b53840.
//
// Solidity: function createToken(uint256 remoteChainID, address remoteToken, uint256 localTokenRate, uint256 remoteTokenRate, uint256 safetyLimit, string symbol, uint8 decimals) returns(address tokenAddress)
func (_StandardBridge *StandardBridgeSession) CreateToken(remoteChainID *big.Int, remoteToken common.Address, localTokenRate *big.Int, remoteTokenRate *big.Int, safetyLimit *big.Int, symbol string, decimals uint8) (*types.Transaction, error) {
	return _StandardBridge.Contract.CreateToken(&_StandardBridge.TransactOpts, remoteChainID, remoteToken, localTokenRate, remoteTokenRate, safetyLimit, symbol, decimals)
}

// CreateToken is a paid mutator transaction binding the contract method 0x79b53840.
//
// Solidity: function createToken(uint256 remoteChainID, address remoteToken, uint256 localTokenRate, uint256 remoteTokenRate, uint256 safetyLimit, string symbol, uint8 decimals) returns(address tokenAddress)
func (_StandardBridge *StandardBridgeTransactorSession) CreateToken(remoteChainID *big.Int, remoteToken common.Address, localTokenRate *big.Int, remoteTokenRate *big.Int, safetyLimit *big.Int, symbol string, decimals uint8) (*types.Transaction, error) {
	return _StandardBridge.Contract.CreateToken(&_StandardBridge.TransactOpts, remoteChainID, remoteToken, localTokenRate, remoteTokenRate, safetyLimit, symbol, decimals)
}
...
func (_StandardBridge *StandardBridgeTransactor) RegisterToken(opts *bind.TransactOpts, remoteChainID *big.Int, isOrigin bool, localToken common.Address, remoteToken common.Address, localTokenRate *big.Int, remoteTokenRate *big.Int, safetyLimit *big.Int) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "registerToken", remoteChainID, isOrigin, localToken, remoteToken, localTokenRate, remoteTokenRate, safetyLimit)
}

// RegisterToken is a paid mutator transaction binding the contract method 0x4227fd2d.
//
// Solidity: function registerToken(uint256 remoteChainID, bool isOrigin, address localToken, address remoteToken, uint256 localTokenRate, uint256 remoteTokenRate, uint256 safetyLimit) returns()
func (_StandardBridge *StandardBridgeSession) RegisterToken(remoteChainID *big.Int, isOrigin bool, localToken common.Address, remoteToken common.Address, localTokenRate *big.Int, remoteTokenRate *big.Int, safetyLimit *big.Int) (*types.Transaction, error) {
	return _StandardBridge.Contract.RegisterToken(&_StandardBridge.TransactOpts, remoteChainID, isOrigin, localToken, remoteToken, localTokenRate, remoteTokenRate, safetyLimit)
}

// RegisterToken is a paid mutator transaction binding the contract method 0x4227fd2d.
//
// Solidity: function registerToken(uint256 remoteChainID, bool isOrigin, address localToken, address remoteToken, uint256 localTokenRate, uint256 remoteTokenRate, uint256 safetyLimit) returns()
func (_StandardBridge *StandardBridgeTransactorSession) RegisterToken(remoteChainID *big.Int, isOrigin bool, localToken common.Address, remoteToken common.Address, localTokenRate *big.Int, remoteTokenRate *big.Int, safetyLimit *big.Int) (*types.Transaction, error) {
	return _StandardBridge.Contract.RegisterToken(&_StandardBridge.TransactOpts, remoteChainID, isOrigin, localToken, remoteToken, localTokenRate, remoteTokenRate, safetyLimit)
}
...
func (_StandardBridge *StandardBridgeTransactor) SetRewardWallet(opts *bind.TransactOpts, nexus_ common.Address) (*types.Transaction, error) {
	return _StandardBridge.contract.Transact(opts, "setRewardWallet", nexus_)
}

// SetRewardWallet is a paid mutator transaction binding the contract method 0x5958621e.
//
// Solidity: function setRewardWallet(address nexus_) returns()
func (_StandardBridge *StandardBridgeSession) SetRewardWallet(nexus_ common.Address) (*types.Transaction, error) {
	return _StandardBridge.Contract.SetRewardWallet(&_StandardBridge.TransactOpts, nexus_)
}

// SetRewardWallet is a paid mutator transaction binding the contract method 0x5958621e.
//
// Solidity: function setRewardWallet(address nexus_) returns()
func (_StandardBridge *StandardBridgeTransactorSession) SetRewardWallet(nexus_ common.Address) (*types.Transaction, error) {
	return _StandardBridge.Contract.SetRewardWallet(&_StandardBridge.TransactOpts, nexus_)
}
...
// StandardBridgeBridgeTokenBatchProcessedIterator is returned from FilterBridgeTokenBatchProcessed and is used to iterate over the raw logs and unpacked data for BridgeTokenBatchProcessed events raised by the StandardBridge contract.
type StandardBridgeBridgeTokenBatchProcessedIterator struct {
	Event *StandardBridgeBridgeTokenBatchProcessed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StandardBridgeBridgeTokenBatchProcessedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StandardBridgeBridgeTokenBatchProcessed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StandardBridgeBridgeTokenBatchProcessedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StandardBridgeBridgeTokenBatchProcessedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StandardBridgeBridgeTokenBatchProcessed represents a BridgeTokenBatchProcessed event raised by the StandardBridge contract.
type StandardBridgeBridgeTokenBatchProcessed struct {
	Permit  bool
	Success []bool
	Reason  []string
	Raw     types.Log // Blockchain specific contextual infos
...
func (_StandardBridge *StandardBridgeFilterer) FilterBridgeTokenBatchProcessed(opts *bind.FilterOpts, permit []bool) (*StandardBridgeBridgeTokenBatchProcessedIterator, error) {
	...
	logs, sub, err := _StandardBridge.contract.FilterLogs(opts, "BridgeTokenBatchProcessed", permitRule)
	if err != nil {
		return nil, err
	}
	return &StandardBridgeBridgeTokenBatchProcessedIterator{contract: _StandardBridge.contract, event: "BridgeTokenBatchProcessed", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event BridgeTokenBatchProcessed(bool indexed permit, bool[] success, string[] reason)
func (_StandardBridge *StandardBridgeFilterer) WatchBridgeTokenBatchProcessed(opts *bind.WatchOpts, sink chan<- *StandardBridgeBridgeTokenBatchProcessed, permit []bool) (event.Subscription, error) {
	...
	logs, sub, err := _StandardBridge.contract.WatchLogs(opts, "BridgeTokenBatchProcessed", permitRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StandardBridgeBridgeTokenBatchProcessed)
				if err := _StandardBridge.contract.UnpackLog(event, "BridgeTokenBatchProcessed", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BridgeTokenBatchProcessed(bool indexed permit, bool[] success, string[] reason)
func (_StandardBridge *StandardBridgeFilterer) ParseBridgeTokenBatchProcessed(log types.Log) (*StandardBridgeBridgeTokenBatchProcessed, error) {
	event := new(StandardBridgeBridgeTokenBatchProcessed)
	if err := _StandardBridge.contract.UnpackLog(event, "BridgeTokenBatchProcessed", log); err != nil {
		return nil, err
	}
...
func (_StandardBridge *StandardBridgeFilterer) FilterRewardWalletSet(opts *bind.FilterOpts, wallet []common.Address) (*StandardBridgeRewardWalletSetIterator, error) {
	...
	logs, sub, err := _StandardBridge.contract.FilterLogs(opts, "RewardWalletSet", walletRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event RewardWalletSet(address indexed wallet)
func (_StandardBridge *StandardBridgeFilterer) WatchRewardWalletSet(opts *bind.WatchOpts, sink chan<- *StandardBridgeRewardWalletSet, wallet []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _StandardBridge.contract.WatchLogs(opts, "RewardWalletSet", walletRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// StandardBridgeValidatorUpdatedIterator is returned from FilterValidatorUpdated and is used to iterate over the raw logs and unpacked data for ValidatorUpdated events raised by the StandardBridge contract.
type StandardBridgeValidatorUpdatedIterator struct {
	Event *StandardBridgeValidatorUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StandardBridgeValidatorUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StandardBridgeValidatorUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StandardBridgeValidatorUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StandardBridgeValidatorUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StandardBridgeValidatorUpdated represents a ValidatorUpdated event raised by the StandardBridge contract.
type StandardBridgeValidatorUpdated struct {
...
func (_StandardBridge *StandardBridgeFilterer) FilterValidatorUpdated(opts *bind.FilterOpts, validator []common.Address, status []bool) (*StandardBridgeValidatorUpdatedIterator, error) {
	...
	logs, sub, err := _StandardBridge.contract.FilterLogs(opts, "ValidatorUpdated", validatorRule, statusRule)
	if err != nil {
		return nil, err
	}
	return &StandardBridgeValidatorUpdatedIterator{contract: _StandardBridge.contract, event: "ValidatorUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ValidatorUpdated(address indexed validator, bool indexed status)
func (_StandardBridge *StandardBridgeFilterer) WatchValidatorUpdated(opts *bind.WatchOpts, sink chan<- *StandardBridgeValidatorUpdated, validator []common.Address, status []bool) (event.Subscription, error) {
	...
	logs, sub, err := _StandardBridge.contract.WatchLogs(opts, "ValidatorUpdated", validatorRule, statusRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StandardBridgeValidatorUpdated)
				if err := _StandardBridge.contract.UnpackLog(event, "ValidatorUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ValidatorUpdated(address indexed validator, bool indexed status)
func (_StandardBridge *StandardBridgeFilterer) ParseValidatorUpdated(log types.Log) (*StandardBridgeValidatorUpdated, error) {
	event := new(StandardBridgeValidatorUpdated)
	if err := _StandardBridge.contract.UnpackLog(event, "ValidatorUpdated", log); err != nil {
		return nil, err
	}
