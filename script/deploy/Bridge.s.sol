...
contract BridgeScript is Script {
    ...
    function deployBaseBridgeProxy() public returns (address) {
        ...
        address proxy = address(
            new ERC1967Proxy(
                address(0x0b526c7AC326F89c50C3268585fD89AD13b2fDF2),
                abi.encodeCall(BaseBridge.initialize, (owner, dev, threshold))
            )
        );
    ...
    function _setupBridge(address bridge) internal {
        ...
        CrossMintableERC20Code erc20 = new CrossMintableERC20Code(address(baseBridge));
        ...
        console.log("CrossMintableERC20Code will be deployed to", address(erc20));
